...
#ifndef UNICODE
#pragma message("Please enable UNICODE VS: Project Properties -> General -> Character Set -> Use Unicode")
#define UNICODE
#define _UNICODE
#endif
	...
	void GameThread()
	{
		...
		while (m_bAtomActive)
		{
			...
			while (m_bAtomActive)
			{
				...
				swprintf_s(sNewTitle, 256, L"Console %s - FPS: %3.2f", m_sAppName.c_str(), 1.0f / fElapsedTime);
